...
The US has signed the [Wassenaar](wassenaar.md) Arrangement, but does not implement the (pre-December 1998) General Software Note and generally maintains stricter controls.
